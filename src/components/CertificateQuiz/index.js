...
import { schema } from "./componentUtils";
...
const CertificateQuiz = ({ content }) => {
    ...
    const submitForm = (data) => sendEmail(data, certificateRef).then(() => { reset() });
        ...
        <div className="max-w-[600px] mx-auto ">
            ...
            <form onSubmit={handleSubmit(submitForm)}>
                ...
                <div className="flex">
                    ...
                    <Button type="submit" as={'button'} colorType={Object.keys(errors).length > 0 ? 'disabled' : ''} disabled={Object.keys(errors).length > 0} classes={`!w-fit !min-w-[140px] !min-h-0 !px-[10px] shadow-2xl `}>Send</Button>
                </div>
