    ...
    return (
        <div ref={fixedSection} id="how_it_works" className="bg-gray3Xl pt-[24px] md:pt-[70px]">
            ...
            <div className="h-[140ch] sm:h-[200ch]">
                <div className="sticky top-[150px] sm:top-0 max-w-[1100px] mx-auto overflow-hidden after:content-[''] after:absolute after:top-0 after:w-full after:h-20 after:sm:h-60 after:bg-gray-gradient">
