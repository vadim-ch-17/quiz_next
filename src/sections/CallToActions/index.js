        ...
        <div className="bg-lightPrimary py-[38px]">
            <div className="container grid grid-cols-1 lg:grid-cols-2">
                <div className="flex flex-col justify-center msax-w-[545px]">
                    <p className={`wow fadeIn ${font.className} text-white text-[25px] md:text-[45px] mb-[29px] md:mb-[68px] text-center lg:text-left`} data-wow-duration="0.2s">{content.title}</p>
